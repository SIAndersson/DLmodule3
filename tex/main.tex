...
\paragraph{Coverage} builds nearest neighbour manifolds around real samples and measures the ratio of the real samplesthat has fake samples in their neighborhood. \cite{naeem2020reliablefidelitydiversitymetrics}
